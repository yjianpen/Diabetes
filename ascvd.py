...
print(compute_ten_year_score(isMale=True,isBlack=False,smoker=False,hypertensive=True,diabetic=True,age=70,systolicBloodPressure=140,totalCholesterol=170,hdl=50))
